...
public class ModMemoryTypes {
    ...
    public static final MemoryModuleType<GlobalPos> FLOWER_POS = register("flower_pos");
    public static final MemoryModuleType<GlobalPos> HIVE_POS = register("hive_pos");
